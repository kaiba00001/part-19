...
namespace DoctorAp.Controllers
{
    public class MedicineReportsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MedicineName,Dosage,Frequency,DirectionsForUse")] MedicineReport medicineReport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MedicineName,Dosage,Frequency,DirectionsForUse")] MedicineReport medicineReport)
        {
