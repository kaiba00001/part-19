...
namespace DoctorAp.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,RoomId,RoomNumber,Capacity,Status")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,RoomId,RoomNumber,Capacity,Status")] Room room)
        {
            if (id != room.Id)
            {
                return NotFound();
